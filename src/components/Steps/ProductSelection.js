...
const products = [
  {
    id: 'term-loan',
    name: 'Term Loan',
    description: 'Fixed-term business loan for equipment, expansion, or working capital needs.',
    features: ['Competitive rates', 'Flexible terms up to 10 years', 'No early repayment fees'],
  ...
  },
  {
    id: 'green-loan',
    name: 'Green Loan',
    description: 'Special rates for environmentally sustainable business investments.',
    features: ['Reduced interest rates', 'Support for renewable energy', 'Sustainability reporting'],
    icon: SparklesIcon,
    minAmount: '€10,000',
    maxAmount: '€1,000,000'
  },
  {
    ...
    features: ['Pay interest only on amount used', 'Immediate access to funds', 'Flexible repayment'],
  ...
  },
  {
    ...
    features: ['Cashback rewards', 'Expense tracking', 'Multiple employee cards'],
    icon: CreditCardIcon,
    minAmount: '€500',
    maxAmount: '€50,000'
  }
...
function ProductSelection() {
  ...
  const handleNext = () => {
    if (selectedProducts.length === 0) {
      setErrors({ products: 'Please select at least one product to continue.' });
      return;
    }
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
          Choose the credit products that best fit your business needs. You can select multiple products 
          and we'll create a tailored application for each.
        </p>
      </div>
        ...
        {products.map((product) => {
          ...
          return (
            <div
              ...
              className={`card card-selectable ${isSelected ? 'card-selected' : ''}`}
              role="button"
              tabIndex={0}
              onKeyDown={(e) => {
      ...
      <div className="bg-blue-50 rounded-lg p-6">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          <li>• This application is fully compliant with Irish and EU regulations</li>
