...
function CreditAgreement() {
  ...
  const requiresMultiPartySignature =
  ...
  const handleScrollToBottom = () => {
    ...
    if (agreementElement) {
      const isAtBottom =
        ...
        agreementElement.scrollHeight - 10;
  ...
  const validateForm = () => {
    ...
    if (!hasReadAgreement) {
      newErrors.agreement =
        'Please read the complete agreement by scrolling to the bottom';
    }
  ...
  const handleMultiPartySignComplete = (multiPartySignatureData) => {
    dispatch(
      applicationActions.updateCreditAgreement({
        signed: true,
        agreementText: sampleCreditAgreement,
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 max-w-2xl mx-auto">
            You will receive a copy via email, and funds will be disbursed
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <div className="font-medium text-gray-900">
                {new Date(state.creditAgreement.signedDate).toLocaleDateString(
                  'en-IE',
                  {
                    year: 'numeric',
                    month: 'long',
            ...
            <div>
              ...
              <div className="font-medium text-gray-900">
                {isMultiParty
                  ? 'Multi-Party Electronic Signature'
                  : 'Single Party Electronic Signature'}
              </div>
            </div>
            <div>
          ...
          {isMultiParty && (
            <div className="mt-6">
              ...
              <div className="space-y-3">
                {state.creditAgreement.signatureData.parties?.map(
                  (party, index) => (
            ...
            <div className="mt-6">
              <div>
                ...
                <div className="font-cursive text-lg text-gray-900">
                  {state.creditAgreement.signatureData}
                </div>
              </div>
            </div>
          )}
    ...
    <div className="space-y-8">
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-sm text-gray-500">eIDAS Compliant</div>
        </div>
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span
              className={`text-sm ${
                hasReadAgreement ? 'text-green-600' : 'text-gray-500'
              }`}
            >
              {hasReadAgreement
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <label
              ...
              className={`text-sm ${
                !hasReadAgreement ? 'text-gray-400' : 'text-gray-700'
              }`}
            >
              I have read, understood, and agree to all terms and conditions of
              this Credit Agreement. I acknowledge that this agreement is
      ...
      <div className="bg-amber-50 rounded-lg p-6">
        ...
        <ul className="text-sm text-amber-700 space-y-1">
          <li>
            • Electronic signatures comply with eIDAS (EU) No 910/2014
            regulation
          </li>
          <li>
            • This process creates a legally binding agreement equivalent to
            handwritten signatures
          </li>
          <li>
            • Your signature is timestamped and includes IP address verification
          </li>
          <li>
            • You can withdraw from this agreement within 14 days (cooling-off
            period)
          </li>
        </ul>
      </div>
